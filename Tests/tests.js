...
module.exports = {
    ...
    'PHONE error Messages and CORRECT it- Excessive characters' : browser => {
            ...
            editEmployee(pageObject, '@employee3' , 
            [{field: '@titleInput' , value: 'Drive Dad Crazy'} , 
            {field: '@nameInput' , value: 'Declan'} , 
            {field: '@phoneInput' , value: '18016028315'}])
            pageObject
            ...
            [{field: '@titleInput' , value: 'Drive Dad Crazy'} , 
            {field: '@nameInput' , value: 'Declan'} , 
            {field: '@phoneInput' , value: '8016028315'}])
            pageObject
    ...
    'TITLE error Messages and CORRECT it- Excessive characters' : browser => {
            ...
            editEmployee(pageObject, '@employee4' , 
            [{field: '@titleInput' , value: 'Buff Guy But Not as Buff as His Dad. Boo YA!!!!'} , 
            {field: '@nameInput' , value: 'Peyton'} , 
            {field: '@phoneInput' , value: '8016028315'}])
            pageObject
    ...
    'TITLE error Messages and CORRECT it - TOO FEW Characters' : browser => {
        ...
        // .api.pause (3000)
            ...
            .verify.elementNotPresent('@phoneError')
            editEmployee(pageObject, '@employee4' , 
                [{field: '@titleInput' , value: 'Buff Guy'} , 
                {field: '@nameInput' , value: 'Peyton'} , 
                {field: '@phoneInput' , value: '8016028315'}])
            pageObject
            .verify.elementNotPresent('@titleError')
    ...
    'NAME error Messages and CORRECT it- Excessive characters' : browser => {
            ...
            editEmployee(pageObject, '@employee5' , 
            [{field: '@titleInput' , value: 'Sweet Girl'} , 
            {field: '@nameInput' , value: 'Jordyn is such a stinker but we still love her no matter what'} , 
            {field: '@phoneInput' , value: '8016028315'}])
            pageObject
    ...
    //refer to "Generating errors" https://dmutah.atlassian.net/browse/DEM-7
    //      & "Correcting errors" https://dmutah.atlassian.net/browse/DEM-10
'NAME error Messages appears and CORRECT it- Too Few Characters': browser => {
        editEmployee(pageObject, '@employee5',

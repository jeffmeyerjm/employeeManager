...
//errorMessages  
        phoneError: {selector: '//div[text()="The phone number must be 10 digits long. "]',
                    locateStrategy: 'xpath'
                    },
        nameError: {selector: '//div[text()="The name field must be between 1 and 30 characters long. "]',
                    locateStrategy: 'xpath'
                    },
        titleError: {selector: '//span[text()="The title field must be between 1 and 30 characters long. "]',
                    locateStrategy: 'xpath'},
